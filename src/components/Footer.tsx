...
export default async function Footer() {
    ...
    // Construct URLs: prioritize database settings, fallback to constants
    const facebookUrl = settings.facebook_url || CONTACT_INFO.socials.facebook;
    const instagramUrl = settings.instagram_url || CONTACT_INFO.socials.instagram;
    const twitterUrl = settings.twitter_url || CONTACT_INFO.socials.twitter;
